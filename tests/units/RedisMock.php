    ...
    class RedisMock extends test
    {
        public function testSetGetDelExists()
        {
            ...
            $this->assert->boolean($redisMock->exists('test'))->isFalse()->variable($redisMock->get('test'))->isNull(
              ...
              ->string($redisMock->setex('test1', 5, 'something'))->isEqualTo('OK')->string(
              ...
              ->string($redisMock->set('test1', 'something'))->isEqualTo('OK')->string(
              ...
              ->string($redisMock->set('test3', 'something', 1))->isEqualTo('OK')->string(
